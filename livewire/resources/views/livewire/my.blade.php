        ...
        <div class="col-12 p-0">    
          <div class="login-card login-dark">
            <div>
              ...
              <div><a class="logo" href="#"><img class="img-fluid for-dark" src="{{ asset('images/logo/logo.png') }}" alt="looginpage"><img class="img-fluid for-light" src="{{ asset('images/logo/logo_dark.png') }}" alt="looginpage"></a></div>
