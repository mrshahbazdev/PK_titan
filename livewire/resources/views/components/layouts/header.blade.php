      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">  
            <div class="logo-wrapper"> <a href="index-2.html"><img class="img-fluid for-light" src="/assets/uploads/img/new_logo.png" alt="logo-light"><img class="img-fluid for-dark" src="{{ asset('backend/images/logo/logo.png ') }}" alt="logo-dark"></a></div>
