              ...
              <div class="container w100" data-v-60f2d5b2="">
                ...
                <div class="van-nav-bar van-hairline--bottom" data-v-60f2d5b2="">
                  <div class="van-nav-bar__content"><a href="home">
                    ...
                    <div class="van-nav-bar__title van-ellipsis">Live Agent</div><!---->
                  </div>
                </div>
                <div class="banner" data-v-60f2d5b2=""><img src="<?php echo $query->siteLogo; ?>" alt="" class="logo" data-v-60f2d5b2="">
                  <p class="text" data-v-60f2d5b2="">Contact us with Live Agent</p>
                  <p class="desc-text" data-v-60f2d5b2="">Operating hours: 12:00 to 12:00 Mon-Sun</p>
                  <div class="btn-wrap" data-v-60f2d5b2="">
                    <div data-id="e027c6bd0c" class="livechat_button"><a href="https://t.me/Titan_travel">Chat Now</a></div>
