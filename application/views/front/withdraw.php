<html lang="en" style="margin: 0px auto; font-size: 107.1px;"><head>
  ...
  <div class="main-layout" data-v-08abc850="">
    <div class="top-bar flex" data-v-b585d98c="" data-v-08abc850="">
      ...
      <div class="w100" data-v-0b8ab34c="" data-v-74290877=""><div class="form-wrap" data-v-0b8ab34c=""><div class="form-item balance" data-v-0b8ab34c=""><div class="title" data-v-0b8ab34c="">Account Balance</div><div class="text" data-v-0b8ab34c="">Rs <?php echo number_format($balance->balance, 2); ?></div></div><div class="form-item" data-v-0b8ab34c=""><div class="title" data-v-0b8ab34c="">Withdrawal Method</div><strong class="text" data-v-0b8ab34c="">Transfer To Bank Address</strong><div class="card" data-v-0b8ab34c=""><?php echo $_SESSION['username']; ?></div><div class="card" data-v-0b8ab34c=""><?php if (isset($bank)) {
        echo $bank->bankName;
      } ?></div><div class="card" data-v-0b8ab34c=""><?php if (isset($bank)) {
        echo $bank->cardNumber;
      } ?></div><div class="card" data-v-0b8ab34c=""><?php if (isset($bank)) {
        echo $bank->phoneNumber;
      } ?></div></div>

      <div style="color: red; font-size: 20px;"><?php if (isset($error)) {
        print_r($error);
      } ?></div>
      <div style="color: green; font-size: 20px;"><?php if (isset($errro['success'])) {
