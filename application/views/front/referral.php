...
<div class="content-box" data-v-dad6ad44="">
    <div class="list-top" data-v-dad6ad44="">
        <img src="assets/referral_3591611.png" alt="" data-v-dad6ad44="">
        <div class="title" data-v-dad6ad44="">Referral Chain</div>
    </div>
    ...
    <ul class="tree">
        <?php function renderTree($tree) { ?>
            <?php foreach ($tree as $node) { ?>
                <li>
                    <div class="node" onclick="toggleTree(this)">
                        <?= $node->username ?> (<?= $node->myCode ?>)<br>
                        <small>Level: <?= $node->memberLevel ?> | Balance: <?= $node->balance ?></small>
                    </div>
