      ...
      <div class="van-config-provider" data-v-08abc850="" style="--van-primary-color: #3f8ed0; --van-button-primary-background-color: #3f8ed0;">
        <div class="container w100" data-v-9fe837d0="">
          ...
          <div class="head-top" data-v-9fe837d0="">
            <div class="msg-wrap" data-v-9fe837d0="">
              <img src="assets/notice-icon-1.ee9da213.png" class="notice-icon" data-v-9fe837d0="">
              <div role="alert" class="van-notice-bar flex-auto" data-v-9fe837d0="">
                <!---->
                <div role="marquee" class="van-notice-bar__wrap">
                  <div class="van-notice-bar__content" style="transition-duration: 0s;"></div>
                </div>
                <!---->
              </div>
            </div>
            <div class="userInfo" data-v-9fe837d0="">
              <span data-v-9fe837d0="" style="color:#200404 !important;">Hi, <?php echo $_SESSION['username']; ?></span>
            </div>

            

            <p class="title" data-v-9fe837d0="" style="color:#200404 !important;">Welcome to <br data-v-9fe837d0=""> 
              <?php echo $query->siteTitle; ?>
             </p>
          </div>
          <div class="content" data-v-9fe837d0="">

            <div class="banner" data-v-9fe837d0="">
              <!-- add animation her -->
            </div>


            <div class="section-title" data-v-9fe837d0="" style="color: white;">Membership</div>
            <div class="vip-wrap" data-v-9fe837d0="">
              <div class="vip-list" data-v-9fe837d0="">
                ...
                <div class="vip-item" data-v-9fe837d0="">
                  ...
                  <div class="status" data-v-9fe837d0="">
                    <div data-v-9fe837d0=""><?php 
                    if ($user->memberLevel == $value->level) {
                    	echo 'Unlock';
                    }elseif ($user->memberLevel == $value->level) {
                      echo 'Unlock';
                    }elseif ($user->memberLevel == $value->level) {
                      echo 'Unlock';
                    }elseif ($user->memberLevel == $value->level) {
                      echo 'Unlock';
                    	...
                    	echo '<img class="lock" src="assets/lock.png" width="12" data-v-9fe837d0="">';
                    }  ?></div>
