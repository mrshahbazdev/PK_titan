...
<body style="font-size: 12px;"><svg id="__svg__icons__dom__1705120061777__" style="position: absolute; width: 0px; height: 0px;">
        ...
        <div class="main-layout" data-v-08abc850="">
          ...
          <div class="main-container" data-v-08abc850="">
            <div class="van-config-provider" data-v-08abc850="" style="--van-primary-color: #3f8ed0; --van-button-primary-background-color: #3f8ed0;">
              <div class="container h100 w100" data-v-3c53dda0="">
                <div class="content" data-v-3c53dda0="">
                  <div class="van-nav-bar van-hairline--bottom" data-v-3c53dda0="">
                    <div class="van-nav-bar__content"><a href="home">
                      ...
                      <div class="van-nav-bar__title van-ellipsis"><?php echo $faq->TextName; ?></div><!---->
                    </div>
                  </div>
                  <div class="help-main" data-v-3c53dda0="">
                    <div class="help-detile" data-v-3c53dda0="">
                      <?php echo $faq->TextContent; ?>
                    </div>
                  </div>
                </div>
              </div>
