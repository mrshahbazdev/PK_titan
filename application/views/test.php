                                      ...
                                      <div role="none" class="n-scrollbar-container">
                                        <div role="none" class="n-scrollbar-content" style="width: fit-content; min-width: 100%;">
                                          <table class="n-data-table-table" style="table-layout: auto;">
                                            ...
                                            <thead class="n-data-table-thead" data-n-id="0aae875d">
                                              <tr class="n-data-table-tr">
                                                ...
                                                <th colspan="1" rowspan="1" data-col-key="qq" class="n-data-table-th">QQ
                                                  <!---->
                                                  <!---->
                                                </th>
                                                <th colspan="1" rowspan="1" data-col-key="wechat" class="n-data-table-th">
                                                  <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">WeChat</font>
                                                  </font>
                                                  <!---->
                                                  <!---->
                                                </th>
                                                <th colspan="1" rowspan="1" data-col-key="link" class="n-data-table-th">Link
                                                  <!---->
                                                  <!---->
                                                </th>
                                                <th colspan="1" rowspan="1" data-col-key="job_time" class="n-data-table-th">Work Time
                                                  <!---->
                                                  <!---->
                                                </th>
                                            ...
                                            <tbody data-n-id="0533a4c4" class="n-data-table-tbody">
    <?php foreach ($users as $user): ?>
    <tr class="n-data-table-tr" id="<?= $user['id'] ?>">
      <td colspan="1" rowspan="1" data-col-key="username" class="n-data-table-td n-data-table-td--last-row username">
        <?= $user['username'] ?>
      </td>
      <td colspan="1" rowspan="1" data-col-key="mobile" class="n-data-table-td n-data-table-td--last-row mobileNumber">
        <?= $user['mobileNumber'] ?>
      </td>
      <td colspan="1" rowspan="1" data-col-key="qq" class="n-data-table-td n-data-table-td--last-row qq">
        <?= $user['qq'] ?>
      </td>
      <td colspan="1" rowspan="1" data-col-key="wechat" class="n-data-table-td n-data-table-td--last-row id wechat">
        <!----><?= $user['weChat'] ?>
      </td>
      <td colspan="1" rowspan="1" data-col-key="link" class="n-data-table-td n-data-table-td--last-row link">
        <?= $user['link'] ?>
      </td>
      <td colspan="1" rowspan="1" data-col-key="job_time" class="n-data-table-td n-data-table-td--last-row workTime">
        <?= $user['workTime'] ?>
      </td>
    ...
    <?php endforeach; ?>
                                ...
                                <div class="n-data-table__pagination">
                                  <div class="n-pagination" style="--n-prefix-margin: 0 8px 0 0; --n-suffix-margin: 0 0 0 8px; --n-item-font-size: 14px; --n-select-width: unset; --n-select-margin: 0 0 0 8px; --n-input-width: 60px; --n-input-margin: 0 0 0 8px; --n-input-margin-rtl: 0 8px 0 0; --n-item-size: 28px; --n-item-text-color: rgb(51, 54, 57); --n-item-text-color-disabled: rgba(194, 194, 194, 1); --n-item-text-color-hover: #3c9bff; --n-item-text-color-active: #2d8cf0; --n-item-text-color-pressed: #3c9bff; --n-item-color: #0000; --n-item-color-hover: #0000; --n-item-color-disabled: rgb(250, 250, 252); --n-item-color-active: #0000; --n-item-color-active-hover: #0000; --n-item-color-pressed: #0000; --n-item-border: 1px solid #0000; --n-item-border-hover: 1px solid #0000; --n-item-border-disabled: 1px solid rgb(224, 224, 230); --n-item-border-active: 1px solid #2d8cf0; --n-item-border-pressed: 1px solid #0000; --n-item-padding: 0 4px; --n-item-border-radius: 3px; --n-bezier: cubic-bezier(.4, 0, .2, 1); --n-jumper-font-size: 14px; --n-jumper-text-color: rgb(51, 54, 57); --n-jumper-text-color-disabled: rgba(194, 194, 194, 1); --n-item-margin: 0 0 0 8px; --n-item-margin-rtl: 0 8px 0 0; --n-button-icon-size: 16px; --n-button-icon-color: rgb(51, 54, 57); --n-button-icon-color-hover: rgb(51, 54, 57); --n-button-icon-color-pressed: rgb(51, 54, 57); --n-button-color-hover: #0000; --n-button-color: #0000; --n-button-color-pressed: #0000; --n-button-border: 1px solid rgb(224, 224, 230); --n-button-border-hover: 1px solid rgb(224, 224, 230); --n-button-border-pressed: 1px solid rgb(224, 224, 230);">
                                    ...
                                    <div class="n-pagination-item n-pagination-item--active">
                                      <font style="vertical-align: inherit;">
...
<script type="text/javascript">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // If confirmed, proceed with delete action
                 $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('systems/delete_support'); ?>",
                    data: {userId: userId},
  ...
  $(document).ready(function () {
    $('.status').click(function () {
      ...
      $.get("<?php echo base_url('systems/changeStatusSupport/'); ?>" + userID, function(response) {
            // Handle response
   ...
   $('.addnews #addok').click(function () {
     var formData = $('#addDataForm').serialize();
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('systems/support_add_data'); ?>",
            data: formData,
            success: function(response){
...
==========================**/
        ...
        $(document).ready(function() {
          ...
          $('#ok').on('click', function(event) {
                ...
                // AJAX request
                $.ajax({
                    url: 'systems/update_support', // Update with your controller method URL
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    success: function(response) {
            ...
            $('.edit-user').on('click', function() {
                ...
                $.ajax({
                    url: 'systems/get_support_data/' + userId,
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        $('.addupdate').show();
...
<div role="none" class="n-modal-container addnews" style="display:none; --n-bezier-ease-out: cubic-bezier(0, 0, .2, 1); --n-box-shadow: 0 6px 16px -9px rgba(0, 0, 0, .08), 0 9px 28px 0 rgba(0, 0, 0, .05), 0 12px 48px 16px rgba(0, 0, 0, .03); --n-color: #fff; --n-text-color: rgb(51, 54, 57); z-index: 2000;">
        ...
        <div role="none" class="n-scrollbar-content n-modal-scroll-content">
          ...
          <div class="n-dialog n-dialog--icon-left n-modal" role="dialog" aria-modal="true" style="--n-font-size: 14px; --n-icon-color: #2d8cf0; --n-bezier: cubic-bezier(.4, 0, .2, 1); --n-close-margin: 22px 28px 0 0; --n-icon-margin: 0 4px 0 0; --n-icon-size: 28px; --n-close-size: 18px; --n-close-color: rgba(122, 122, 122, 1); --n-close-color-hover: rgba(89, 89, 89, 1); --n-close-color-pressed: rgba(149, 149, 149, 1); --n-color: #fff; --n-text-color: rgb(51, 54, 57); --n-border-radius: 3px; --n-padding: 16px 28px 20px 28px; --n-line-height: 1.6; --n-border: 1px solid rgb(239, 239, 245); --n-content-margin: 8px 0 16px 0; --n-title-font-size: 18px; --n-title-font-weight: 500; --n-title-text-color: rgb(31, 34, 37); --n-action-space: 12px; transform-origin: -112px 164px;">
            ...
            <div class="n-dialog__title">
              <!---->
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">Add customer service</font>
              </font>
            </div>
            <div id="formMessage" style="color: red;"></div>
            <div class="n-dialog__content">
              <form class="n-form py-4" id="addDataForm">
                <div class="n-form-item __form-item-1mawhsm-ml n-form-item--medium-size n-form-item--left-labelled" >
                  <label class="n-form-item-label" style="width: 120px;">
                    <font style="vertical-align: inherit;">
                    ...
                    <div class="n-input n-input--resizable n-input--stateful" >
                      <div class="n-input-wrapper">
                        ...
                        <div class="n-input__input">
                          <input type="text" id="addusername" class="n-input__input-el" placeholder="Please enter username" size="20" name="addusername">
                          <!---->
                          <!---->
                        </div>
                        <!---->
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" >
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="password" id="addpassword" class="n-input__input-el"  name="addpassword">
                          <!---->
                          <!---->
                        </div>
                        <!---->
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="addmobileNumber" class="n-input__input-el" placeholder="Please enter mobile number" size="20" name="addmobileNumber">
                          <div class="n-input__placeholder"></div>
                          <!---->
                        </div>
                        <!---->
                      </div>
                ...
                <div class="n-form-item __form-item-1mawhsm-ml n-form-item--medium-size n-form-item--left-labelled" >
                  <label class="n-form-item-label" style="width: 120px;">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">QQ</font>
                    </font>
                    <span class="n-form-item-label__asterisk">
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">&nbsp;*</font>
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="addqq" class="n-input__input-el" placeholder="Please enter QQ" size="20" name="addqq">
                          <!---->
                        </div>
                        <!---->
                      </div>
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="addwechat" class="n-input__input-el" placeholder="Please enter WeChat" size="20" name="addweChat">
                          <!---->
                        </div>
                        <!---->
                      </div>
                ...
                <div class="n-form-item __form-item-1mawhsm-ml n-form-item--medium-size n-form-item--left-labelled" style="">
                  <label class="n-form-item-label" style="width: 120px;">
                    <font style="vertical-align: inherit;">
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="addlink" class="n-input__input-el" placeholder="Please enter link" size="20"  name="addlink">
                          <!---->
                        </div>
                        <!---->
                      </div>
                ...
                <div class="n-form-item __form-item-1mawhsm-ml n-form-item--medium-size n-form-item--left-labelled" style="">
                  <label class="n-form-item-label" style="width: 120px;">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Work Time</font>
                    </font>
                    <span class="n-form-item-label__asterisk">
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">&nbsp;*</font>
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="time" id="addworktime" class="n-input__input-el" placeholder="Please enter link" size="20" name="addworkTime">
                          <!---->
                        </div>
                        <!---->
                      </div>
            ...
            <div class="n-dialog__action">
              <div role="none" class="n-space" style="display: flex; flex-flow: wrap; justify-content: flex-start; margin-top: -4px; margin-bottom: -4px;">
                <div role="none" style="max-width: 100%; margin-right: 12px; padding-top: 4px; padding-bottom: 4px;">
                  <button class="n-button n-button--default-type n-button--medium-type" id="close" tabindex="0" type="button" >
                    <!---->
                    <!---->
                    <span class="n-button__content">
                      <font style="vertical-align: inherit;">
        ...
        <div role="none" class="n-scrollbar-content n-modal-scroll-content">
          ...
          <div class="n-dialog n-dialog--icon-left n-modal" role="dialog" aria-modal="true" style="--n-font-size: 14px; --n-icon-color: #2d8cf0; --n-bezier: cubic-bezier(.4, 0, .2, 1); --n-close-margin: 22px 28px 0 0; --n-icon-margin: 0 4px 0 0; --n-icon-size: 28px; --n-close-size: 18px; --n-close-color: rgba(122, 122, 122, 1); --n-close-color-hover: rgba(89, 89, 89, 1); --n-close-color-pressed: rgba(149, 149, 149, 1); --n-color: #fff; --n-text-color: rgb(51, 54, 57); --n-border-radius: 3px; --n-padding: 16px 28px 20px 28px; --n-line-height: 1.6; --n-border: 1px solid rgb(239, 239, 245); --n-content-margin: 8px 0 16px 0; --n-title-font-size: 18px; --n-title-font-weight: 500; --n-title-text-color: rgb(31, 34, 37); --n-action-space: 12px; transform-origin: -112px 164px;">
            ...
            <div class="n-dialog__title">
              <!---->
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">customer service update</font>
              </font>
            </div>
            <div class="n-dialog__content">
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" >
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="username" class="n-input__input-el" placeholder="Please enter username" size="20" name="username">
                          <!---->
                          <!---->
                        </div>
                        <!---->
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="mobileNumber" class="n-input__input-el" placeholder="Please enter mobile number" size="20" name="mobileNumber">
                          <div class="n-input__placeholder"></div>
                          <!---->
                        </div>
                        <!---->
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="qq" class="n-input__input-el" placeholder="Please enter QQ" size="20" name="qq">
                          <!---->
                        </div>
                        <!---->
                      </div>
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="wechat" class="n-input__input-el" placeholder="Please enter WeChat" size="20" name="weChat">
                          <!---->
                        </div>
                        <!---->
                      </div>
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="text" id="link" class="n-input__input-el" placeholder="Please enter link" size="20"  name="link">
                  ...
                  <div class="n-form-item-blank">
                    <div class="n-input n-input--resizable n-input--stateful" style="">
                      <div class="n-input-wrapper">
                        <!---->
                        <div class="n-input__input">
                          <input type="time" id="worktime" class="n-input__input-el" placeholder="Please enter link" size="20" name="workTime">
                          <!---->
                        </div>
                        <!---->
                      </div>
