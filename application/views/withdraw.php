                  ...
                  <div class="layout-content-main layout-content-main-fix" data-v-d9b27248="">
                    <div class="main-view main-view-fix" data-v-d9b27248="">
                      <div data-v-d9b27248="" class="">
                        ...
                        <div class="n-card n-card--bordered" style="--n-bezier: cubic-bezier(.4, 0, .2, 1); --n-border-radius: 3px; --n-color: #fff; --n-color-modal: #fff; --n-color-popover: #fff; --n-color-target: #2d8cf0; --n-text-color: rgb(51, 54, 57); --n-line-height: 1.6; --n-action-color: rgb(250, 250, 252); --n-title-text-color: rgb(31, 34, 37); --n-title-font-weight: 500; --n-close-color: rgba(122, 122, 122, 1); --n-close-color-hover: rgba(89, 89, 89, 1); --n-close-color-pressed: rgba(149, 149, 149, 1); --n-border-color: rgb(239, 239, 245); --n-box-shadow: 0 1px 2px -2px rgba(0, 0, 0, .08), 0 3px 6px 0 rgba(0, 0, 0, .06), 0 5px 12px 4px rgba(0, 0, 0, .04); --n-padding-top: 19px; --n-padding-bottom: 20px; --n-padding-left: 24px; --n-font-size: 14px; --n-title-font-size: 18px; --n-close-size: 18px;"><!----><!----><div class="n-card__content" role="none"><form class="n-form n-form--inline"><div class="n-form-item __form-item-1mawhsm-ml n-form-item--medium-size n-form-item--left-labelled" style="--n-bezier: cubic-bezier(.4, 0, .2, 1); --n-line-height: 1.6; --n-blank-height: 34px; --n-label-font-size: 14px; --n-label-text-align: right; --n-label-height: 26px; --n-label-padding: 0 12px 0 0; --n-asterisk-color: #d03050; --n-label-text-color: rgb(31, 34, 37); --n-feedback-padding: 4px 0 0 2px; --n-feedback-font-size: 14px; --n-feedback-height: 24px; --n-feedback-text-color: rgb(118, 124, 130); --n-feedback-text-color-warning: #f0a020; --n-feedback-text-color-error: #d03050;"><!----><div class="n-form-item-blank"><div  ><div class="n-input-wrapper"><!----><div class="n-input__input"><input type="text" class="n-input__input-el form-control" placeholder="Please enter user name" name="username" size="20" style=""><!----></div><!----></div><!----><!----><div class="n-input__border"></div><div class="n-input__state-border"></div><!----></div></div><div class="n-form-item-feedback-wrapper"><!----></div></div><div class="n-form-item __form-item-1mawhsm-ml n-form-item--medium-size n-form-item--left-labelled" style="--n-bezier: cubic-bezier(.4, 0, .2, 1); --n-line-height: 1.6; --n-blank-height: 34px; --n-label-font-size: 14px; --n-label-text-align: right; --n-label-height: 26px; --n-label-padding: 0 12px 0 0; --n-asterisk-color: #d03050; --n-label-text-color: rgb(31, 34, 37); --n-feedback-padding: 4px 0 0 2px; --n-feedback-font-size: 14px; --n-feedback-height: 24px; --n-feedback-text-color: rgb(118, 124, 130); --n-feedback-text-color-warning: #f0a020; --n-feedback-text-color-error: #d03050;"><!----><div class="n-form-item-blank">
                          <a href="trade/withdraw">
                          <button class="n-button n-button--default-type n-button--small-type mr-1" tabindex="0" type="button" style="--n-bezier: cubic-bezier(.4, 0, .2, 1); --n-bezier-ease-out: cubic-bezier(0, 0, .2, 1); --n-ripple-duration: .6s; --n-opacity-disabled: 0.5; --n-wave-opacity: 0.6; font-weight: 400; --n-color: #0000; --n-color-hover: #0000; --n-color-pressed: #0000; --n-color-focus: #0000; --n-color-disabled: #0000; --n-ripple-color: #2d8cf0; --n-text-color: rgb(51, 54, 57); --n-text-color-hover: #3c9bff; --n-text-color-pressed: #3c9bff; --n-text-color-focus: #3c9bff; --n-text-color-disabled: rgb(51, 54, 57); --n-border: 1px solid rgb(224, 224, 230); --n-border-hover: 1px solid #3c9bff; --n-border-pressed: 1px solid #3c9bff; --n-border-focus: 1px solid #3c9bff; --n-border-disabled: 1px solid rgb(224, 224, 230); --n-width: initial; --n-height: 28px; --n-font-size: 14px; --n-padding: 0 10px; --n-icon-size: 18px; --n-icon-margin: 6px; --n-border-radius: 3px;"><!----><!----><span class="n-button__content">Reset</span><div aria-hidden="true" class="n-base-wave"></div><div aria-hidden="true" class="n-button__border"></div><div aria-hidden="true" class="n-button__state-border"></div></button>
                        </a>
                          <button class="n-button n-button--primary-type n-button--small-type" tabindex="0" type="submit" style="--n-bezier: cubic-bezier(.4, 0, .2, 1); --n-bezier-ease-out: cubic-bezier(0, 0, .2, 1); --n-ripple-duration: .6s; --n-opacity-disabled: 0.5; --n-wave-opacity: 0.6; font-weight: 400; --n-color: #2d8cf0; --n-color-hover: #3c9bff; --n-color-pressed: #3c9bff; --n-color-focus: #3c9bff; --n-color-disabled: #2d8cf0; --n-ripple-color: #2d8cf0; --n-text-color: #FFF; --n-text-color-hover: #FFF; --n-text-color-pressed: #FFF; --n-text-color-focus: #FFF; --n-text-color-disabled: #FFF; --n-border: 1px solid #2d8cf0; --n-border-hover: 1px solid #3c9bff; --n-border-pressed: 1px solid #3c9bff; --n-border-focus: 1px solid #3c9bff; --n-border-disabled: 1px solid #2d8cf0; --n-width: initial; --n-height: 28px; --n-font-size: 14px; --n-padding: 0 10px; --n-icon-size: 18px; --n-icon-margin: 6px; --n-border-radius: 3px;"><!----><!----><span class="n-button__content">Inquiry</span><div aria-hidden="true" class="n-base-wave"></div><div aria-hidden="true" class="n-button__border"></div><div aria-hidden="true" class="n-button__state-border"></div></button></div><div class="n-form-item-feedback-wrapper"><!----></div></div></form><div class="s-table"><div class="n-data-table n-data-table--bordered n-data-table--single-line mt-2" style="--n-font-size: 14px; --n-th-padding: 12px; --n-td-padding: 12px; --n-bezier: cubic-bezier(.4, 0, .2, 1); --n-border-radius: 3px; --n-line-height: 1.6; --n-border-color: rgba(239, 239, 245, 1); --n-border-color-modal: rgba(239, 239, 245, 1); --n-border-color-popover: rgba(239, 239, 245, 1); --n-th-color: rgba(250, 250, 252, 1); --n-th-color-hover: rgba(243, 243, 247, 1); --n-th-color-modal: rgba(250, 250, 252, 1); --n-th-color-hover-modal: rgba(243, 243, 247, 1); --n-th-color-popover: rgba(250, 250, 252, 1); --n-th-color-hover-popover: rgba(243, 243, 247, 1); --n-td-color: #fff; --n-td-color-hover: rgba(247, 247, 250, 1); --n-td-color-modal: #fff; --n-td-color-hover-modal: rgba(247, 247, 250, 1); --n-td-color-popover: #fff; --n-td-color-hover-popover: rgba(247, 247, 250, 1); --n-th-text-color: rgb(31, 34, 37); --n-td-text-color: rgb(51, 54, 57); --n-th-font-weight: 500; --n-th-button-color-hover: rgba(0, 0, 100, 0.03); --n-th-icon-color: rgba(194, 194, 194, 1); --n-th-icon-color-active: #2d8cf0; --n-filter-size: 15px; --n-pagination-margin: 12px 0 0 0; --n-empty-padding: 48px 0; --n-box-shadow-before: inset -12px 0 8px -12px rgba(0, 0, 0, .18); --n-box-shadow-after: inset 12px 0 8px -12px rgba(0, 0, 0, .18); --n-sorter-size: 15px; --n-loading-size: 28px; --n-loading-color: #2d8cf0; --n-opacity-loading: 0.5; --n-td-color-striped: rgba(250, 250, 252, 1); --n-td-color-striped-modal: rgba(250, 250, 252, 1); --n-td-color-striped-popover: rgba(250, 250, 252, 1);"><div class="n-data-table-wrapper"><div class="n-data-table-base-table"><!----><div class="n-data-table-base-table-body n-scrollbar" role="none" style="--n-scrollbar-bezier: cubic-bezier(.4, 0, .2, 1); --n-scrollbar-color: rgba(0, 0, 0, 0.25); --n-scrollbar-color-hover: rgba(0, 0, 0, 0.4); --n-scrollbar-border-radius: 5px; --n-scrollbar-width: 5px; --n-scrollbar-height: 5px;"><div role="none" class="n-scrollbar-container"><div role="none" class="n-scrollbar-content" style="width: fit-content; min-width: 100%;"><table class="n-data-table-table" style="table-layout: auto;"><colgroup><col><col><col></colgroup><thead class="n-data-table-thead" data-n-id="fe686fc1"><tr class="n-data-table-tr"><th colspan="1" rowspan="1" data-col-key="username" class="n-data-table-th">username<!----><!----></th><th colspan="1" rowspan="1" data-col-key="money" class="n-data-table-th">Mobile Phone Number</th><th colspan="1" rowspan="1" data-col-key="money" class="n-data-table-th">Order amount</th><th colspan="1" rowspan="1" data-col-key="money" class="n-data-table-th">Name</th><th colspan="1" rowspan="1" data-col-key="money" class="n-data-table-th">Bank Card Number </th><th colspan="1" rowspan="1" data-col-key="money" class="n-data-table-th">Bank Name </th><th colspan="1" rowspan="1" data-col-key="money" class="n-data-table-th">Time </th>
                            <th colspan="1" rowspan="1" data-col-key="createtime" class="n-data-table-th n-data-table-th--last">Operation</th>
                            <th colspan="1" rowspan="1" data-col-key="createtime" class="n-data-table-th n-data-table-th--last">Status</th>

                          </tr></thead><tbody data-n-id="fe686fc1" class="n-data-table-tbody">
                          <?php foreach ($users as $user): ?>
                          <tr class="n-data-table-tr"><td colspan="1" rowspan="1" data-col-key="username" class="n-data-table-td n-data-table-td--last-row"><!----><?php echo $user['username']; ?></td><td colspan="1" rowspan="1" data-col-key="money" class="n-data-table-td n-data-table-td--last-row"><?php echo $user['phNumber']; ?></td><td colspan="1" rowspan="1" data-col-key="money" class="n-data-table-td n-data-table-td--last-row"><?php echo $user['orderAmount']; ?></td><td colspan="1" rowspan="1" data-col-key="money" class="n-data-table-td n-data-table-td--last-row"><?php echo $user['name']; ?></td><td colspan="1" rowspan="1" data-col-key="money" class="n-data-table-td n-data-table-td--last-row"><?php echo $user['bankCard']; ?></td><td colspan="1" rowspan="1" data-col-key="money" class="n-data-table-td n-data-table-td--last-row"><?php echo $user['bankName']; ?></td><td colspan="1" rowspan="1" data-col-key="createtime" class="n-data-table-td n-data-table-td--last-col n-data-table-td--last-row"><!----><?php echo date("Y-m-d H:i:s", $user['time']); ?></td><td colspan="1" rowspan="1" data-col-key="createtime" class="n-data-table-td n-data-table-td--last-col n-data-table-td--last-row"><!----><?php 

                          if ($user['oprate'] == 0) {
                            echo 'Pending';
                          }elseif ($user['oprate'] == 1) {
                            echo 'Decline';
                          }else{
                            echo 'Approved';
                          } ?></td>

                          <td colspan="1" rowspan="1" data-col-key="createtime" class="n-data-table-td n-data-table-td--last-col n-data-table-td--last-row">
                            <a href="trade/withdrawStatus?pid=<?php echo $user['id']; ?>&status=2&reg=<?php echo current_url(); ?>"><button class="btn btn-success">Approval</button></a>
                            <a href="trade/withdrawStatus?pid=<?php echo $user['id']; ?>&status=1&reg=<?php echo current_url(); ?>">
                        ...
                        </tbody></table></div></div><div class="n-scrollbar-rail n-scrollbar-rail--vertical n-scrollbar-rail--disabled" aria-hidden="true" style="z-index: 3;"><!----></div><div class="n-scrollbar-rail n-scrollbar-rail--horizontal n-scrollbar-rail--disabled" aria-hidden="true" style="z-index: 3;"><!----></div></div></div></div><!----></div></div></div><!----><!----></div>
