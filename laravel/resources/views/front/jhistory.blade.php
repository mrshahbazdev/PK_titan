...
<noscript><a href="https://www.livechat.com/chat-with/17801850/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a></noscript>
<!-- End of LiveChat code --><html lang="en" style="margin: 0px auto; font-size: 107.1px;"><head>
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="assets/SubmitData.297b78ef.css">
  ...
  <div class="main-layout" data-v-08abc850="">
    ...
    <div class="main-container" data-v-08abc850="">
      ...
      <div class="van-config-provider" data-v-08abc850="" style="--van-primary-color: #3f8ed0; --van-button-primary-background-color: #3f8ed0;"><div class="container pb10 w100" data-v-5d4adb0a=""><div class="van-nav-bar van-hairline--bottom" data-v-5d4adb0a=""><div class="van-nav-bar__content">
        <a href="journey">
        ...
        foreach ($total as $key => $value) {
          $query = \App\Models\Product::where('id', $value['productId'])->first();
         if ($value['status'] == 0) {
           
        
         ?>
        <div class="slip-item" data-v-3509fc58="" data-v-5d4adb0a="" style="background: url(&quot;backend/productImage/<?php echo $query->productImage; ?>&quot;) 0% 0% / 100% 100% no-repeat;"><div class="wrap" data-v-3509fc58=""><div class="time-line" data-v-3509fc58=""><div class="status status-0" data-v-3509fc58="">Pending</div></div><div class="goods-line align-start flex" data-v-3509fc58=""><div class="flex-column" data-v-3509fc58=""><div class="time" data-v-3509fc58=""><?php echo date('Y-m-d H:i:s', $value['time']); ?></div><div class="goods-name" data-v-3509fc58=""><?php echo $query->productName; ?></div></div></div><div class="item-footer" data-v-3509fc58=""><div class="money-item" data-v-3509fc58=""><span class="title" data-v-3509fc58="">Total Amount</span><span class="money" data-v-3509fc58="">Rs <?php echo $value['price']; ?></span></div><div class="money-item" data-v-3509fc58=""><span class="title" data-v-3509fc58="">Commissions</span><span class="money" data-v-3509fc58="">Rs <?php echo $value['comission']; ?></span></div><div class="submit-btn" data-v-3509fc58=""><button type="button" data-user-id="<?php echo $value['id']; ?>" class="submit van-button van-button--primary van-button--small van-button--block van-button--round" data-v-3509fc58="" style="color: white; background: #461a3e; border-color: #461a3e;"><div class="van-button__content"><!----><span class="van-button__text">Submit</span><!----></div></button></div></div></div></div>
<?php }else{ ?>

      <div class="slip-item" data-v-3509fc58="" data-v-5d4adb0a="" style="background: url(&quot;backend/productImage/<?php echo $query->productImage; ?>&quot;) 0% 0% / 100% 100% no-repeat;"><div class="wrap" data-v-3509fc58=""><div class="time-line" data-v-3509fc58=""><div class="status status-1" data-v-3509fc58="">Completed</div></div><div class="goods-line align-start flex" data-v-3509fc58=""><div class="flex-column" data-v-3509fc58=""><div class="time" data-v-3509fc58=""><?php echo date('Y-m-d H:i:s', $value['time']); ?></div><div class="goods-name" data-v-3509fc58=""><?php echo $query->productName; ?></div></div></div><div class="item-footer" data-v-3509fc58=""><div class="money-item" data-v-3509fc58=""><span class="title" data-v-3509fc58="">Total Amount</span><span class="money" data-v-3509fc58="">Rs <?php echo $value['price']; ?></span></div><div class="money-item" data-v-3509fc58=""><span class="title" data-v-3509fc58="">Commissions</span><span class="money" data-v-3509fc58="">Rs <?php echo $value['comission']; ?></span></div><div class="submit-btn" data-v-3509fc58=""><!----></div></div></div></div>
<?php }} ?>
...
<script>
  ...
  $(document).ready(function(){
    $('.submit').click(function () {
      window.location.href = "jsubmission";
  });
})
</script>