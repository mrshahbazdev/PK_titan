...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/echart.css">
  ...
  <body> 
          ...
          <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus"> 
              <li class="d-md-block d-none"> 
                <div class="form search-form mb-0">
                  <div class="input-group"><span class="input-icon">
                      <svg>
                        <use href="assets/icon/icon-sprite.svg#search-header"></use>
                      </svg>
              ...
              <li class="onhover-dropdown">
                <svg>
                  <use href="assets/icon/icon-sprite.svg#star"></use>
                </svg>
              ...
              <li class="onhover-dropdown notification-down">
                <div class="notification-box"> 
                  <svg> 
                    <use href="assets/icon/icon-sprite.svg#notification-header"></use>
                                ...
                                <li>
                                  <div class="user-alerts"><img class="user-image rounded-circle img-fluid me-2" src="assets/images/dashboard/user/5.jpg" alt="user"/>
                                    <div class="user-name">
                                      ...
                                      <div> 
                                        <svg>
                                          <use href="assets/icon/icon-sprite.svg#more-vertical"></use>
                                        </svg>
                                      </div>
                                    </div>
                                  </div>
                    ...
                    <div class="card"> 
                      <div class="card-header card-no-border total-revenue pb-0">
                        ...
                        <div class="icon-menu-header">
                          <svg>
                            <use href="assets/icon/icon-sprite.svg#more-horizontal"></use>
                          </svg>
                        </div>
                      </div>
                      <div class="card-body pt-0">
                  ...
                  <div class="card-footer"> 
                    <div class="common-space"> 
                      ...
                      <div class="visited-dropdown"> 
                        <svg class="mb-0"> 
                          <use href="assets/icon/icon-sprite.svg#arrow-down"></use>
                        </svg>
                      </div>
                    </div>
                  </div>
    ...
    <script src="assets/js/config.js"></script>
    <script src="assets/js/facePrint.js"></script>
    <script src="assets/js/testHelper.js"></script>
    <script src="assets/js/custom-transition-texture.js"></script>
    <script src="assets/js/symbols.js"></script>
    <!-- calendar js-->
    <script src="assets/js/datepicker.js"></script>
    <script src="assets/js/datepicker.en.js"></script>
    <script src="assets/js/datepicker.custom.js"></script>
    <script src="assets/js/dashboard_3.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
